...
echo '	
	...
	<div id = "wrapper"> <!-- css division "wrapper" -->
			<div id = "banner"> <!-- css division "banner" -->
			
			<div class="row">
              <div class="column1">
			    <a href = "donate.php"  class="overlay1" title "GIVE"></a>
	          </div>
              <div class="column2" > 
			     <a href = "advocate.php" class="overlay2" title "ADVOCATE"></a>
				   </div>
             <div class="column3" >
			      <a href = "volunteer.php" class="overlay3" title "VOLUNTEER"></a>
				  </div>
			<div class="row2">
				<div class="column4">
	 			<a href = "home.php" class="overlay4" title "HOME"></a>
...
echo '<!-- Footer with info and links -->
		 <div id="footer"> <!-- css division "footer" -->
			...
			<a href="http://www.unitedway.org" target="_blank"><img src="images/uw_icon.png" alt="LIVE UNITED" width="100" style="border: none;" class="img" /></a> <!-- link to unitedway.org -->
