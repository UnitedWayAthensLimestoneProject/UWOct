...
?>
		...
		<div id="admin_form_container">
			...
			<form name="form_edit_volunteer" id="form_edit_volunteer" class="appnitro" method="POST" action="admin_vols.php">
            <fieldset id="editFields" disabled=true>
				<?php
					if ($searchbyvol == 1) {
						$searchbyvol = 0;
				...
				<ul>
					...
					<li class="buttons">
                        ...
                        <input type="submit" name="enableEdit" id="enableEdit" class="button_text" value="Edit">					
							<input type='reset' name='clearEditVolunteer' id='clearEditVolunteer' class='button_text' value='Cancel' onclick='window.location = "admin_vols.php"'>
					</li>
				</ul>
