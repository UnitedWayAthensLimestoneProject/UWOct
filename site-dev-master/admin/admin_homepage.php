  ...
  <div class="form_description" align="left">
		<div class="adminDefaults"> <!-- css division "content" -->
			<div id="headerText" align="center">
					<h2>Admin - Edit Homepage Images</h2>
					<h3>For editing homepage content</h3> <!-- Header 1 style -->
					<!-- PUT STUFF HERE -->
...
<?php
	...
	echo "<br>";
	echo content("image1", "homepageimg");
 ...
 ?>
			...
			<br>
			<img src="<?php content("content1", "homepageimg"); ?>" alt="content" class="sideImg">
			...
			<form action="contentUpload.php" method="post" class="imageButtons" enctype="multipart/form-data">
				...
				<input type="hidden" name="sContent" value="content1">
                 <input type="hidden" name="sContentType" value="homepageimg">
			...
			<br>
			<img src="<?php content("content2", "homepageimg"); ?>" alt="content" class="sideImg">
			...
			<br>
			<img src="<?php content("content3", "homepageimg"); ?>" alt="content" class="sideImg">
